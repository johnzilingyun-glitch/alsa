...
export async function generateAndParseJsonWithRetry<T>(
  ...
  const requestedModel = params.model || DEFAULT_LLM_MODEL;
          ...
          if (functionCalls.length > 0) {
            ...
            if (currentLoop < 3) {
              ...
              for (const part of functionCalls) {
                ...
                console.log(`[LLMTools] Executing tool: ${name}`, args);
              ...
              console.warn(`[LLMTools] Tool loop limit reached (${currentLoop})`);
